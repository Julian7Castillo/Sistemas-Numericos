...
def graficasem(frmps, fun1,fun2,fun3,fun4, r1, r2, r3, r4, r5, r6):
    ...
    l22.place(x = 90, y = 170, width=70, height = 70)
    ...
    l23.place(x = 160, y = 170, width=70, height = 70)
    ...
    l24.place(x = 230, y = 170, width=70, height = 70)
    ...
    l25.place(x = 300, y = 170, width=70, height = 70)
    ...
    l26.place(x = 370, y = 170, width=70, height = 70)
    ...
    l27.place(x = 440, y = 170, width=70, height = 70)
